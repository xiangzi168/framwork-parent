 ...
 * @since 2021-07-30
 */
@TableName("t_logistics_status")
@ApiModel(value="LogisticsStatusDO对象", description="")
public class LogisticsStatusDO implements Serializable {
