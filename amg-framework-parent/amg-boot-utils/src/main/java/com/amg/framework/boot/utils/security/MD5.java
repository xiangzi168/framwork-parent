...
public class MD5 {
	 ...
	 * @return
	 */
	public static String getAccessToken(TreeMap<String,String> sortMap, String appId, String secret) throws Exception {
	 ...
	 * @return
	 */
	public static String createSign(TreeMap<String,String> sortMap, String secret, String timestamp) throws Exception {
