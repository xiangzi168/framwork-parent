...
import com.amg.framework.cloud.grpc.thread.CircuitExecute;
...
public final class ClientCalls {
    ...
    public static <ReqT, RespT> RespT blockingUnaryCall(
        ...
        return (RespT) CircuitExecute.circuit(channel, method, callOptions, req, new Throwable().getStackTrace()[1].getClassName());
    }
