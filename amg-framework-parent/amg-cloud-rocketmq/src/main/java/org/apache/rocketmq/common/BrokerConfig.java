...
public class BrokerConfig {
     ...
     */
    // 增加发送消息线程数
    private int sendMessageThreadPoolNums = 16 + Runtime.getRuntime().availableProcessors() * 4; //16 + Runtime.getRuntime().availableProcessors() * 4;
    ...
    private long waitTimeMillsInSendQueue = 5 * 1000; // 同步刷盘模式调整等待时间
