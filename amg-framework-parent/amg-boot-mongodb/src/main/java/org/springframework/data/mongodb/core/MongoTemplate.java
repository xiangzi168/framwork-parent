...
public class MongoTemplate implements MongoOperations, ApplicationContextAware, IndexOperationsProvider {
	...
	private class ReadDocumentCallback<T> implements DocumentCallback<T> {
		...
		public ReadDocumentCallback(@NonNull EntityReader<? super T, Bson> reader, @NonNull Class<T> type, String collectionName) {
			this.reader = reader;
			this.type = type;
	...
	private class ProjectingReadCallback<S, T> implements DocumentCallback<T> {
		...
		public ProjectingReadCallback(EntityReader<Object, Bson> reader, Class<S> entityType, Class<T> targetType, String collectionName) {
			this.reader = reader;
