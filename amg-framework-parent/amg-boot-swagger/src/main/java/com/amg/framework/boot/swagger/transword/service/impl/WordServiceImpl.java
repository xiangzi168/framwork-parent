package com.amg.framework.boot.swagger.transword.service.impl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.amg.framework.boot.swagger.transword.model.ModelAttr;
import com.amg.framework.boot.swagger.transword.model.Request;
import com.amg.framework.boot.swagger.transword.model.Response;
import com.amg.framework.boot.swagger.transword.model.Table;
import com.amg.framework.boot.swagger.transword.service.WordService;
import com.amg.framework.boot.swagger.transword.utils.JsonUtils;
import com.amg.framework.boot.utils.http.HttpUtil;
    ...
    public Map<String, Object> tableList(String swaggerUrl) {
        ...
        try {
           // String jsonStr = restTemplate.getForObject(swaggerUrl, String.class);
            String jsonStr = HttpUtil.get(swaggerUrl);
